...
[![Github Actions Status](https://github.com/elyra-ai/elyra/workflows/Build/badge.svg)](https://github.com/elyra-ai/elyra/actions/workflows/build.yml)
...
folder is located. Then you can remove the symlink named `@elyra/pipeline-editor-extension` within that folder.
